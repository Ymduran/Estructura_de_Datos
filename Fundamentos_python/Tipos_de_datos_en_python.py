...
print(" *                                                        * ")
print(" * Fecha: 08 octubre del 2024                             * ")
print(" *                                                        * ")
print(" * Descripción:                                           *")
print(" * Usos de los tipos básico de datos en Python.           * ")
print(" * * * * * * * * * * * * * * * * * * * * * * * * * * *  * * ")
print(" ")
print(" ")
...
- Int;  por ejemplo que edad = 1
- Float; por ejemplo  pi = 3.1416
- String (str); por ejemplo palabra = "vocal" 
- Boolean. True o False (con inicial mayúscula); por ejemplo Es_Estudiante = True
- None. Tipo especial que representa una ausencia de valor; Por ejemplo cero = None
"""
...
# Cadena de texto
mi_variable_texto_nombre = "Yamm"
mi_variable_texto_apellido = 'Durán' # Con comillas simple también se imprime
