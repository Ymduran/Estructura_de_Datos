...
preguntas = [
    {"pregunta": "¿Cuál de las siguientes opciones odiarías más que la gente te llamara?",
     "respuestas": {"Gryffindor": "Ordinario", "Slytherin": "Ignorante", "Hufflepuff": "Cobarde",
                    "Ravenclaw": "Egoísta"}},
    {"pregunta": "Después de tu muerte, ¿qué es lo que más le gustaría que hiciera la gente cuando escuche tu nombre?",
     "respuestas": {"Gryffindor": "Te extraña, pero sonríe", "Slytherin": "Pide más historias sobre tus aventuras",
    ...
    {"pregunta": "¿Qué cualidad te describe mejor?",
     "respuestas": {"Gryffindor": "La fuerza", "Slytherin": "La astucia", "Hufflepuff": "La paciencia",
                    "Ravenclaw": "La inteligencia"}},
    {"pregunta": "¿Cuál es tu clase favorita?",
     "respuestas": {"Gryffindor": "Vuelo", "Slytherin": "Defensa contra las artes oscuras",
                    "Hufflepuff": "Animales fantásticos", "Ravenclaw": "Pociones"}},
...
{"pregunta": "Elige un superpoder: ",
     "respuestas": {"Gryffindor": "Dormir", "Slytherin": "Invisibilidad", "Hufflepuff": "Súperfuerza", "Ravenclaw": "Teletransportarse"}}
]
...
def iniciar_test():
    ...
    while len(preguntas_seleccionadas) < 7:  # Lo hará cinco veces, pusto que solo se ocupan 5 preguntas
        indice = random.randint(0,
                                len(preguntas) - 1)  # Índice de la lista de preguntas, se seleccionará aleatoriamente
    ...
    for indice in preguntas_seleccionadas:  # Ahora con la lista de preguntas hecha, en cada
        ...
        respuestas = list(pregunta[
                              "respuestas"].items())  # Y lo combierte a una lista las respuestas del diccionario, la converión se hace con list y el ,item accede al valor del diccionario, es decir clave y diccionario
        ...
        opciones = {str(i + 1): respuesta[1] for i, respuesta in enumerate(
            respuestas)}  # Se asigna  a la variable "opciones" las respuestas de del diccionario de respuestas, y como no se moestrará las casa, por eso semuestra la siguiente posición
