...
for variable in secuencia: #En donde la variable será un elemento dentro de una secuencia, la variable secuencia es la secuencia
    Una cadena puede a su vez ser una secuencia en donde cada caracter es un elemento individual
'''
...
#En python se puede añadir un nuevo elemento sin causar errores, a comparación de c en dónde se definían la cantidad de elementos a utilizar
...
for i in range(1, 11): #Range en una palabra reserada para añadir una secuencia de números range(número_inicial,número final).General números del número_final-1
    print(i, end= ", " )
