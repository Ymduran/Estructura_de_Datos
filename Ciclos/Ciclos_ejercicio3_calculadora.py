...
while opcion !=0: #Mientras que la opción sea diferente de cero seguirá mostrando el menú, al presionar cero será equivalente a la opción "salir"
    print(" ** Menú: ** ")
    print("[0].- Salir")
    print("[1].- Suma")
    print("[2].- Resta")
    ...
    if opcion==1:#suma
        numero1, numero2 = float(input("Ingrese primer número: ")), float(input("Ingrese segundo número: ")) #Lee los datos por teclado
        print(f"{numero1} + {numero2} = {(numero1 + numero2):.2f}") #Hace la suma de los números en el print
        print("  ")
    elif opcion==2:#resta
        numero1, numero2 = float(input("Ingrese primer número: ")), float(input("Ingrese segundo número: ")) #Lee los datos por teclado
        print(f"{numero1} - {numero2} = {(numero1 - numero2):.2f}") #Hace la resta de los números en el print
        print("  ")
    elif opcion==3:#multiplicación
        numero1, numero2 = float(input("Ingrese primer número: ")), float(input("Ingrese segundo número: ")) #Lee los datos  por teclado
        print(f"{numero1} * {numero2} = {(numero1 * numero2):.2f}") #Hace la multiplicación de los números desde el print y muestra los resultados
        print("  ")
        ...
        print("saliendo...") #Justo antes de romper el cilo iimprime este letrero
    else:
